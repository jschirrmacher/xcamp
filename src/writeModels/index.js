module.exports = ({ store, rack, mailSender, Payment, mailChimp, templateGenerator, config, readModels, adapters }) => {
  const Model = {}

  Model.Person = require('./person')(store, readModels, config, adapters)

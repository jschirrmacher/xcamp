...
module.exports = function (config) {
  return {
    ...
    earlybird: {category: 'earlybird', name: 'Early Bird', price: config.ticketCategories.earlybird, restricted: true},
    private:   {category: 'private', name: 'Selbstzahler', price: config.ticketCategories.private},
    lastminute:{category: 'lastminute', name: 'Last Minute', price: config.ticketCategories.lastminute},
